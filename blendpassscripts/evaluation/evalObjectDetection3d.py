...
from blendpassscripts.helpers.annotation import (
    CsBbox3d,
    CsIgnore2d
)
from blendpassscripts.helpers.box3dImageTransform import (
    Box3dImageTransform,
    Camera
)
from blendpassscripts.evaluation.objectDetectionHelpers import (
...
def evaluate3dObjectDetection(
    ...
    if plot:
        ...
        from blendpassscripts.evaluation.plot3dResults import plot_data

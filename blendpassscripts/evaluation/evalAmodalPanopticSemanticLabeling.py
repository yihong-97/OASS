#!/usr/bin/python
#
# The evaluation script for amodal panoptic segmentation (https://arxiv.org/abs/1801.00868).
...
def main():
    ...
    #
    # evaluateAmodalPanoptic(args.gtJsonFile, args.gtFolder, args.predictionJsonFile, args.predictionFolder, args.resultsFile)

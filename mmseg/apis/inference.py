...
def inference_segmentor_oass(model, img):
    ...
    # --- ADDED BY SUMAN ON JULY 29 2022 ---
    ...
    kwargs = {}
    kwargs['eval_kwargs'] = dict(
                interval=1, # since there wont be any mIoU evaluation - this is not used
                metric='mIoU',
                eval_type='oass_deeplab',
                oass_eval_folder='',
                oass_eval_temp_folder='',
                dataset_name='cityscapes',
                gt_dir='',
                debug=False,
                num_samples_debug=12,
                gt_dir_oass='',  # this is set in mmseg/apis/train.py
